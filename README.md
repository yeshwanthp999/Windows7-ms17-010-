...
![Nmap smb-vuln script output](Windows7-ms17-010-/Screenshots/vulnaribilityscan3.png)
...
![Metasploit search output](Windows7-ms17-010-/Screenshots/Metasploit4.png)

* I confirmed that an interactive remote session was established to the host, with a timestamp included in the capture.
![Meterpreter session output](Windows7-ms17-010-/Screenshots/Meterpreter5.png)
...
![Meterpreter sysinfo output](Windows7-ms17-010-/Screenshots/Meterpreter5.png)

* I also attempted to use a `bypassuac` exploit, but the exploit aborted because the session was already in an elevated state.
![BypassUAC attempt](Windows7-ms17-010-/Screenshots/otherexploits6.png)
...
![hashdump output](Windows7-ms17-010-/Screenshots/Credentialdump7.png)
...
![File creation confirmation](Windows7-ms17-010-/Screenshots/privilegeescalation8.png)

* I used the `getuid` command to show that the session was running with elevated privileges as `NT AUTHORITY\SYSTEM`.
![getuid output](Windows7-ms17-010-/Screenshots/privilege%20escalation%209.png)
