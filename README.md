...
![Nmap smb-vuln script output](vulnaribilityscan3.png)
...
![Meterpreter sysinfo output](Meterpreter5.png)
...
![hashdump output](Credentialdump7.png)
...
![File creation confirmation](privilegeescalation8.png)

* Finally, I used the `getuid` command to show that the session was running with elevated privileges as `NT AUTHORITY\SYSTEM`.
![getuid output](privilege%20escalation%209.png)
